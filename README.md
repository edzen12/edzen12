...
## ⚙️ Focus Areas
- Разработка устойчивых и масштабируемых веб-приложений  
- Проектирование архитектуры **LMS и CRM систем**  
- API-интеграции, микросервисы, оптимизация производительности  
- Настройка CI/CD и контейнеризация приложений
